# ShikiApiStatic.GetPublishers - метод


Получить список издательств манги
...
Тип:&nbsp;<a target="_blank" href="http://msdn2.microsoft.com/ru-ru/library/6sh2ey19" target="_top">List</a>(Studio)
